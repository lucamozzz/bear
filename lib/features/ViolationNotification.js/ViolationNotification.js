import { GUARD_VIOLATION_EVENT, SYNTAX_VIOLATION_EVENT, NOT_REACHABLE_EVENT, DIFFERENT_POSITION_EVENT } from '../../util/EventHelper';
...
export default function ViolationNotification(eventBus, animation, elementRegistry, log, elementNotifications, canvas) {
	...
	this._eventBus.on(DIFFERENT_POSITION_EVENT, function(context) {
