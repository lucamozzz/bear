...
const DISCORDANT_MOVE_WHILE_BOUND_EVENT = 'tokenSimulation.discordantMovement';
const NOT_REACHABLE_EVENT = 'tokenSimulation.destinationNotReachable';
const DIFFERENT_POSITION_EVENT = 'tokenSimulation.differentPosition';
const NO_ROOT_EVENT = 'tokenSimulation.rootPositionNotSet';
